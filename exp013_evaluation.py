...
def evaluate_exp013_evidence(
    *,
    ...
    common = {
        "combined_walk_forward_net_profit_positive": combined > 0.0,
        "selected_nq_profit_factor_above_one": (
            float(nq_summary["trade_profit_factor"]) > 1.0
        ),
        "two_tick_nq_net_profit_positive": (
            float(nq_two_tick_summary["net_profit_usd"]) > 0.0
        ),
    }
    strong = {
        **common,
        "discovery_wide_mcpt_p_value_at_most_0p05": (
            float(discovery_wide_mcpt_p_value) <= 0.05
        ),
    ...
    promising = {
        **common,
        "discovery_wide_mcpt_p_value_at_most_0p10": (
            float(discovery_wide_mcpt_p_value) <= 0.10
        ),
        "at_least_two_profitable_walk_forward_folds": (
            profitable_folds >= 2
        ),
    }
    ...
    return {
        ...
        "combined_walk_forward_net_profit_usd": combined,
        "discovery_wide_mcpt_p_value": float(
